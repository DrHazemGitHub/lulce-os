...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Initializing Status
    self.status.set("Welcome To Lulce-Pad")
    # Creating Menubar
  ...
  def infoabout(self):
    messagebox.showinfo("About Text Editor","Lulce-Pad is a simple text editor included with the LulceOS")
